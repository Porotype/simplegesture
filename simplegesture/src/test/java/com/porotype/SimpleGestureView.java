...
import com.porotype.simplegesture.DirectionsDiagram;
...
public class SimpleGestureView extends VerticalLayout {
    ...
    public SimpleGestureView() {
        ...
        add(new HorizontalLayout(recordButton, normalize, maxDistance));
        ...
        simpleGesture.getStyle().setZIndex(1);

        var directionsDiagram = new DirectionsDiagram();
        directionsDiagram.getStyle().set("user-select", "none");

        VerticalLayout verticallayout = new VerticalLayout();
        verticallayout.add(status, directionsDiagram, gestureGrid);
        verticallayout.addAndExpand(gestureGrid);
