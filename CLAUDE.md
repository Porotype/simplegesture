...
- **`com.porotype.base`**: Reusable components and base classes for all features
...
- **`com.porotype.examplefeature`**: Example feature demonstrating the structure
...
1. Create a new package under `com.porotype` (e.g., `com.porotype.myfeature`)
