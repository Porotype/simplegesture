import { r as f, b as c, E as g, B as i, w as b, a3 as m, _ as t, G as $ } from "./copilot-DI3-W1-o.js";
import { B as v } from "./base-panel-Cr-JNsTK.js";
import { i as e } from "./icons-CDpVUE5Q.js";
...
var w = Object.getOwnPropertyDescriptor, x = (o, l, h, p) => {
  for (var s = p > 1 ? void 0 : p ? w(l, h) : l, n = o.length - 1, r; n >= 0; n--)
    (r = o[n]) && (s = r(s) || s);
  return s;
};
...
function a(o) {
  return i`<span class="kbds">${m(o)}</span>`;
}
const C = $({
