import { r as b, M as S, u as ue, v as N, b as h, j as l, C as Y, w as p, x as P, y as oe, z as O, O as ye, A as R, B as r, D as X, F as ct, G as pt, H as ht, I as f, J as Z, K as $e, L as ke, E as g, N as Be, k as se, l as Ve, P as Fe, Q as ut, V as gt, R as Je, S as E, T as c, U as ft, W as z, X as k, Y as qe, Z as vt, _ as re, $ as mt, a0 as Se, a1 as xe, a2 as bt, a3 as wt, a4 as yt, a5 as xt, a6 as We, a7 as Pt, a8 as It, a9 as Ct, aa as At, ab as Ge, ac as $t, ad as kt, ae as St, af as Et, ag as Xe, ah as Rt, ai as Pe, aj as Ie, ak as Dt } from "./copilot-DI3-W1-o.js";
import { n as w, r as y } from "./state-CV9KAofd.js";
import { e as T } from "./query-BykXNUlT.js";
import { i as d } from "./icons-CDpVUE5Q.js";
import { c as Ye } from "./index-D2xVFBEy.js";
...
function _t(e, t) {
  ...
  return e.map((s) => {
    const a = s.panelInfo;
    return a && !a.expanded ? Ee : (t.offsetHeight - (t.position === "bottom" ? zt : 0) - o * Ee - i * Lt) / n;
  });
}
...
let M = class extends S {
  constructor() {
    super(...arguments), this.position = "right", this.opened = !1, this.keepOpen = !1, this.resizing = !1, this.closingForcefully = !1, this.draggingSectionPanel = null, this.drawerDragLeaveListener = (e) => {
      const { x: t, y: i } = e;
      ue(this.getBoundingClientRect(), t, i) ? this.debounceHideDrawerWhenDragLeave.clear() : this.debounceHideDrawerWhenDragLeave();
      ...
      if (!ue(this.getBoundingClientRect(), t, i)) {
...
let Q = class extends X {
  constructor() {
    super(...arguments), this.checked = !1, this.documentMouseDownEventClickListener = (e) => {
      const t = ct([this]);
      ue(t, e.x, e.y) || (this.inputElement.blur(), document.removeEventListener("mousedown", this.documentMouseDownEventClickListener, { capture: !0 }));
    };
  }
  static get styles() {
    return O`
...
class jt {
  ...
  adjust(t, i, n, o, s) {
    ...
    return (o + i) / 2 < L / 2 ? (t.style.setProperty("--left", `${i}px`), t.style.setProperty("--right", ""), I = void 0, a = Math.max(0, i)) : (t.style.removeProperty("--left"), t.style.setProperty("--right", `${L - o}px`), a = void 0, I = Math.max(0, L - o)), (n + s) / 2 < ae / 2 ? (u = Math.max(0, n), t.style.setProperty("--top", `${u}px`), t.style.setProperty("--bottom", ""), m = void 0) : (t.style.setProperty("--top", ""), t.style.setProperty("--bottom", `${ae - s}px`), u = void 0, m = Math.max(0, ae - s)), {
      left: a,
      right: I,
      top: u,
      bottom: m
...
let C = class extends S {
  ...
  renderPluginIsNotInstalledContent(e) {
    ...
    return e.intellij ? (t = ut, i = "Install from JetBrains Marketplace") : e.vscode ? (t = gt, i = "Install from VSCode Marketplace") : e.eclipse && (t = ke, i = "Install from Eclipse Marketplace"), r`
      <div>
  ...
  renderHotswapAgentJdkSection(e) {
    const t = f.jdkInfo?.extendedClassDefCapable, i = this.downloadStatusMessages?.[this.downloadStatusMessages.length - 1] === De;
    return r`
      <div class="inner-section">
        <details class="inner" .open="${!t}">
          <summary>
  ...
  async downloadJetbrainsRuntime(e) {
    return e.target.disabled = !0, e.preventDefault(), this.downloadStatusMessages = [], se(`${Fe}set-up-vs-code-hotswap`, {}, (t) => {
      t.data.error ? (Ve("Error downloading JetBrains runtime", t.data.error), this.downloadStatusMessages = [...this.downloadStatusMessages, "Download failed"]) : this.downloadStatusMessages = [...this.downloadStatusMessages, De];
    });
  }
...
let Le = class extends S {
  ...
  render() {
    const t = Je(), i = t.status === "warning" || t.status === "error";
    return r`
...
function Ze(e) {
  return se("copilot-switch-user", { username: e }, (t) => t.data.error ? (z({ type: k.ERROR, message: "Unable to switch user", details: t.data.error.message }), !1) : !0);
}
...
let G = class extends S {
  constructor() {
    super(...arguments), this.initialMouseDownPosition = null, this.dragging = !1, this.items = [], this.mouseDownListener = (e) => {
      ...
      this.dragging && (this.setSubMenuVisibility(!1), $.dragging(this, e));
        ...
        children: [
            ...
            children: [
              {
                ...
                keepOpen: !0,
                action: (o) => {
                  c.setActivationShortcut(!c.isActivationShortcut()), ce(o, c.isActivationShortcut());
                }
              },
              {
                component: v({
                ...
                keepOpen: !0,
                action: (o) => {
                  c.setActivationAnimation(!c.isActivationAnimation()), ce(o, c.isActivationAnimation());
                }
              },
              {
                component: v({
              ...
              },
              {
                ...
                keepOpen: !0,
                action: (o) => {
                  c.setSendErrorReportsAllowed(!c.isSendErrorReportsAllowed()), ce(o, c.isSendErrorReportsAllowed());
                }
              },
              { component: "hr" },
              {
          ...
          },
          {
            component: v({
              icon: d.vaadinLogo,
              label: "Copilot",
              hint: c.isActivationShortcut() ? re.toggleCopilot : void 0,
...
let _ = class extends S {
  constructor() {
    super(...arguments), this.panelTag = "", this.dockingItems = [
      ...
      this.panelInfo?.floating && (this.floatingResizingStarted || (this.removeAttribute("resizing"), this.removeAttribute(pe), this.removeAttribute("dragging"), this.style.removeProperty("--resize-cursor"), this.removeAttribute(x), this.panelInfo != null && this.panelInfo.height != null && this.panelInfo?.height > window.innerHeight && (p.updatePanel(this.panelInfo.tag, {
      ...
      const { width: t, height: i } = this.getBoundingClientRect(), { left: n, top: o, bottom: s, right: a } = $.anchor(this), u = window.getComputedStyle(this.container), m = Number.parseInt(u.borderTopWidth, 10), I = Number.parseInt(u.borderBottomWidth, 10);
    ...
    `;
      ...
      if (this.panelInfo)
        if (e.stopPropagation(), Se(this), this.panelInfo?.floating)
      ...
      this.panelInfo && (e.stopPropagation(), $.anchorLeftTop(this), p.updatePanel(this.panelInfo.tag, {
  ...
  setResizePosition(e, t, i) {
    const n = this.rectangleBeforeResizing, o = 0, s = window.innerWidth, a = 0, u = window.innerHeight, m = Math.max(o, Math.min(s, t)), I = Math.max(a, Math.min(u, i));
    if (e === "left")
  ...
  changeDockingPanel(e) {
    ...
    if (this.panelInfo?.panel !== t) {
      ...
      Se(this), p.updatePanel(this.panelInfo.tag, { panel: t, panelOrder: i + 1 });
    }
...
const ui = {
   ...
   */
  run(e) {
    me || (me = !0, queueMicrotask(() => hi())), j.push(e);
    const t = He;
    return He += 1, t;
  },
  /**
...
class bi extends mi {
  ...
  /** @override */
  update(t, [i, n]) {
    return this.hasChanged(n) ? (this.host = t.options && t.options.host, this.element = t.element, this.renderer = i, this.previousValue === je ? this.addRenderer() : this.runRenderer(), this.previousValue = Array.isArray(n) ? [...n] : n, g) : g;
  }
  /** @override */
  reconnected() {
    this.addRenderer();
...
const ot = Pe(wi), st = Pe(yi), at = Pe(xi);
...
h.on("endpoint-response", (e) => {
  ...
  n === 200 ? (i.details = `Response: ${ne(t)}`, i.expandedDetails = Ie(
